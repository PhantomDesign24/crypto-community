...
define('G5_MYSQL_USER', 'crypto');
define('G5_MYSQL_PASSWORD', '@3W]uXv--qHVJRjS');
define('G5_MYSQL_DB', 'crypto');
define('G5_MYSQL_SET_MODE', true);

define('G5_TABLE_PREFIX', 'g5_');

define('G5_TOKEN_ENCRYPTION_KEY', '891e91471993b5c56d535ce12cedd358'); // 토큰 암호화에 사용할 키
